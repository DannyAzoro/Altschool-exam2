...
<VirtualHost *:80>
    ServerAdmin azoroebuka@gmail.com
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=danny/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=danny/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=azoro2020/' /var/www/html/laravel/.env
